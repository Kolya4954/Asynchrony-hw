...
const number = setInterval(()=>{
    ...
    if (count === 5) clearInterval(number);
}, 1000);
...
const styles = setInterval(()=>{
    ...
    if (style === 1) divRef.style.backgroundColor = 'red';
    if (style === 2) divRef.style.backgroundColor = 'blue';
    if (style === 3) divRef.style.backgroundColor = 'green';
    if (style === 4) clearInterval(styles);
}, 1000);
...
btnStart.addEventListener("click", ()=>{
    ...
    setTimeout(()=>{
        if (isNaN(time)) titleRef.textContent = "\u0412\u0432\u0435\u0434\u0456\u0442\u044C \u0447\u0438\u0441\u043B\u043E";
        else titleRef.textContent = `\u{42F} \u{437}'\u{44F}\u{432}\u{438}\u{43B}\u{430}\u{441}\u{44C} \u{43F}\u{456}\u{441}\u{43B}\u{44F} ${inputRef.value} \u{441}\u{435}\u{43A}\u{443}\u{43D}\u{434}(-\u{438})!`;
    }, time);
});

},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequireddab", {})

//# sourceMappingURL=Asynchrony-hw.1fcc916e.js.map
